"""Generate the Jupyter notebook version of the Rigol basic tutorial."""
...
NOTEBOOK = {
    ...
    "cells": [
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## Step 1: Find and connect to the scope"],
        },
        {
            "cell_type": "code",
            "execution_count": None,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## Step 2: Automated measurements"],
        },
        {
            "cell_type": "code",
            "execution_count": None,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## Step 3: Capture the waveform itself"],
        },
        {
            "cell_type": "code",
            "execution_count": None,
...
output_path = Path(__file__).resolve().parent / "rigol_basic_tutorial.ipynb"
